<template>
  <div class="category-admin">
    <b-form>
      ...
      <b-row>
        <b-col xs="12">
          <b-form-group label="Categoria:" lobel-for="category-name">
            <b-form-input
              id="category-name"
              type="text"
      ...
      <b-row>
        <b-col xs="12">
          <b-form-group label="Categoria Pai:" lobel-for="category-parentId">
            <b-form-select
              v-if="mode === 'save'"
    ...
    <b-table hover stiped :items="categories" :fields="fields">
